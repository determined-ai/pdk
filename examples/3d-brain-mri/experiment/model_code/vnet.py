...
(to support dropout parametrization)
from here:
https://github.com/black0017/MedicalZooPytorch/blob/master/lib/medzoo/Vnet.py
"""
...
class DownTransition(nn.Module):
    def __init__(self, inChans, nConvs, elu, dropout=0.5):
        super().__init__()
        outChans = 2 * inChans
...
class VNet(nn.Module):
    ...
    def __init__(self, in_channels=1, classes=4, dropout=0.5, elu=True):
        super().__init__()
        self.classes = classes
        self.in_channels = in_channels
        ...
        self.down_tr128 = DownTransition(64, 3, elu, dropout=self.dropout)
        self.down_tr256 = DownTransition(128, 2, elu, dropout=self.dropout)
        self.up_tr256 = UpTransition(256, 256, 2, elu, dropout=self.dropout)
        self.up_tr128 = UpTransition(256, 128, 2, elu, dropout=self.dropout)
